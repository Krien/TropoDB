...
constexpr static uint8_t L0_circular_logs =
    2; /**< Number of L0 circular logs. Increases parallelism. */
constexpr static int L0_slow_down =
    60; /**< Amount of SSTables in L0 before client puts will be stalled. Can
...
constexpr static double ss_compact_treshold[level_count]{
    ...
    128. * 1024. * 1024.,
    512. * 1024. * 1024.,
    2048. * 1024. * 1024.}; /**< Size of each level before we want
...
constexpr static uint64_t max_bytes_sstable_l0 =
    1024U * 1024U * 64; /**< Maximum size of SSTables in L0. Determines the
...
constexpr static uint64_t max_lbas_compaction_l0 = 2097152 * 6; /**< Maximum
